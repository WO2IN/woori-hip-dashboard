  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          className="flex items-center gap-2 h-8 px-2.5 text-sm font-medium hover:bg-muted rounded-lg"
          aria-label="사용자 메뉴"
        >
          ...
          <span className={`hidden sm:flex items-center gap-0.5 text-[11px] font-medium ${ROLE_COLOR[user.role]}`}>
            {ROLE_ICON[user.role]}
          </span>
        </Button>
      </DropdownMenuTrigger>
