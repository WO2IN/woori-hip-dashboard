  ...
  return <div className="report-page">
    ...
    <div className="report-workspace">
      ...
      <div className="quality-report">
        <header className="report-header-grid"><div className="report-logo">WOORI</div><div className="report-main-title">QUALITY ASSURANCE REPORT<span>성적서</span></div><Field label="CUSTOMER (고객명)" value={values.customer} onChange={update('customer')} /><Field label="DESCRIPTION (품명)" value={values.product} onChange={update('product')} /><Field label="LOT NO. (로트번호)" value={values.lotNo} onChange={update('lotNo')} /><Field label="ISSUED DATE (발행일자)" value={values.issueDate} onChange={update('issueDate')} /><Field label="규격 (제품)" value={values.specification} onChange={update('specification')} /><Field label="LOT SIZE (수량)" value={values.quantity} onChange={update('quantity')} /><Field label="검사일자" value={values.inspectionDate} onChange={update('inspectionDate')} /></header>
